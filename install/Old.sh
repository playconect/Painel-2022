...
wget github.com/playconect/SincAI/raw/SincAI/sincarm/sshplus.zip.001 > /dev/null 2>&1
wget github.com/playconect/SincAI/raw/SincAI/sincarm/sshplus.zip.002 > /dev/null 2>&1
wget github.com/playconect/SincAI/raw/SincAI/sincarm/sshplus.zip.003 > /dev/null 2>&1
...
clear
service ssh restart
echo -e "\033[1;32mUall!!!, você conseguiu...\033[0m"
sleep 3
clear
