...
wget https://github.com/playconect/Painel-2022/raw/main/pweb/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://github.com/playconect/Painel-2022/raw/main/pweb/verifatt.sh > /dev/null 2>&1
wget https://github.com/playconect/Painel-2022/raw/main/pweb/verpweb > /dev/null 2>&1
wget https://github.com/playconect/Painel-2022/raw/main/pweb/verweb > /dev/null 2>&1
...
wget https://github.com/playconect/Painel-2022/raw/main/pweb/gestorssh.zip > /dev/null 2>&1
